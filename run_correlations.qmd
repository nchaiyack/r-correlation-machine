...
run_correlations <- function(
  ...
  dir_map <- .normalize_directionality(directionality_map, predictor_vars = pred_names, default = default_directionality)
  ...
  .debug_vars(debug_print, "Outcome", outcome_name)
  .debug_vars(debug_print, "Predictor vars", pred_names)
  .debug_map(debug_print, "Method map", method_by_pred)
  .debug_map(debug_print, "Directionality", dir_map)
  .debug_vars(debug_print, "Stratification vars", strat_names)
  .debug_stratification(
    ...
    if(bonferroni_correct) {
      ...
      .debug_bonf(debug_print, bonf_info)
    } else {
...
mtcars %>% run_correlations(
  mpg,
  stratification_vars = c(cyl, gear, carb),
